...
interface ModernBookingCalendarProps {
  ...
  onCreateClubEvent?: (courtId?: string, date?: string, time?: string) => void
}
    ...
    const handleCellClick = () => {
      ...
      if (cellBookings.length === 0) {
        ...
        if (onCreateClubEvent) {
          onCreateClubEvent(court.id, format(day, 'yyyy-MM-dd'), time)
        }
      }
    }
                            ...
                            <div className="h-[60px] relative">
                              ...
                              <div 
                                ...
                                onClick={() => {
                                  ...
                                  if (onCreateClubEvent) {
                                    onCreateClubEvent(court.id, format(new Date(), 'yyyy-MM-dd'), time)
                                  }
                                }}
                              >
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
