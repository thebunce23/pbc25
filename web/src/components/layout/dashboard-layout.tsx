...
export default function DashboardLayout({ children, title }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg border-r transform transition-transform duration-300 ease-in-out
      ...
      `}>
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b bg-white">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-900">Pickleball Club</h1>
            </div>
          </div>
          <Button
            variant="ghost"
