...
export default function AddPlayerForm({ open, onOpenChange, onSubmit }: AddPlayerFormProps) {
  ...
  const handleFormSubmit = async (data: PlayerFormData) => {
    ...
    try {
      ...
      setError(err.message || 'An error occurred while adding the player')
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new player to your club. Fill out the required information below.
          </DialogDescription>
        </DialogHeader>
