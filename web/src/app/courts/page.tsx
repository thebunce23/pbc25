...
export default function CourtsPage() {
  ...
  const [clubEventContext, setClubEventContext] = useState<{courtId?: string, date?: string, time?: string} | null>(null)
  ...
  const handleCreateClubEventWithContext = (courtId?: string, date?: string, time?: string) => {
    setClubEventContext({ courtId, date, time })
    setIsClubEventOpen(true)
  }
    ...
    <DashboardLayout title="Courts & Bookings">
      <div className="space-y-6">
        ...
        />
          ...
          <TabsContent value="bookings" className="space-y-6">
            <ModernBookingCalendar
              ...
              onCreateClubEvent={handleCreateClubEventWithContext}
            />
          </TabsContent>
        </Tabs>
        ...
        <ClubEventForm
          ...
          onOpenChange={(open) => {
            setIsClubEventOpen(open)
            if (!open) {
              setClubEventContext(null) // Clear context when closing
            }
          }}
          onSubmit={handleCreateClubEvent}
          courts={courts}
          defaultCourtId={clubEventContext?.courtId}
          defaultDate={clubEventContext?.date}
          defaultTime={clubEventContext?.time}
        />
